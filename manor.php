...
<h1>The Dovecote</h1>
<h3 class="slight"> Beautifully secluded B&B</h3>
</div>
...
<!-- <div class="flexslider">
          <ul class="slides">
            <li>
              <img src="images/portfo/dc-01.jpg" alt="">
             </li>
            <li>
              <img src="images/portfo/dc-02.jpg" alt="">
             </li>
            <li>
              <img src="images/portfo/dc-03.jpg" alt="">
             </li>
              <li>
              <img src="images/portfo/dc-04.jpg" alt="">
             </li>
            <li>
              <img src="images/portfo/dc-05.jpg" alt="">
             </li>
            <li>
              <img src="images/portfo/dc-06.jpg" alt="">
             </li>
...
<h4 class="subtitle">What does the dovecote include</h4>
<hr class="vertical-space1">
...
<td>Projector</td>
<td>4</td>
<td>LED project, includes cables for a mac</td>
</tr>
...
<h4 class="subtitle">Where in the manor is it?</h4>
...
<!--  Plan End -->
  ...
  <section class="related-works">
    <div class="container">
      <div class="sixteen columns">
        <h4 class="subtitle">Other areas to stay and rent </h4>
      </div>
      <div class="clear"></div>
